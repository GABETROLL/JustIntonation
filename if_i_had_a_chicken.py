...
melody = Melody(
    ...
    [
        ...
        [Note(f, duration_in_beats=2) for f in [G1, G2,         G4, E5]], [], # CORRECTED.
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     G4, E5]], [],
        [Note(f, duration_in_beats=2) for f in [C2, C3,         G4, E5]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4]] + [Note(f) for f in [F_SHARP_FROM_B_4, D_SHARP_FROM_B_5]],
        [Note(f, duration_in_beats=3) for f in [F4, D_FROM_F_5]],
        ...
        [Note(f, duration_in_beats=2) for f in [D_FROM_G_1, D_FROM_G_1,     G4, E5]], [],
        ...
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4]], [],
        [Note(f, duration_in_beats=2) for f in [C2, C3,         E5, C6]], [], # CORRECTED.
        [Note(f, duration_in_beats=2) for f in [C2, C3,         E5, C6]], [], # CORRECTED.
        [Note(f, duration_in_beats=2) for f in [C2, C3,         E5, C6]], [], # CORRECTED.
        [], [],
        ...
        [Note(f, duration_in_beats=1) for f in [C4, E4]], [Note(f, duration_in_beats=2) for f in [C4, G4]],
        ...
        [], [],
        [Note(f, duration_in_beats=8) for f in [G1, G2, B3, G4]], [],
        [], [],
        [], [],
        [], [],
        [], [],
        ...
        [Note(f, duration_in_beats=2) for f in [C2, C3,         E5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     G5]], [],
        [Note(f, duration_in_beats=2) for f in [G1, G2,         E5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4]] + [Note(G5)], [Note(f, duration_in_beats=2) for f in [E5, C6]],
        [Note(f, duration_in_beats=2) for f in [C2, C3]], [Note(f) for f in [E5, C6]],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     G5]], [],
        [Note(f, duration_in_beats=2) for f in [G1, G2,         E5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     G5]], [],

        [Note(f, duration_in_beats=2) for f in [A_FLAT_1, A_FLAT_2,        E_FLAT_5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4,    A_FLAT_5]], [],
        [Note(f, duration_in_beats=2) for f in [E_FLAT_1, E_FLAT_2,        E_FLAT_5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4]] + [Note(A_FLAT_5)], [Note(f, duration_in_beats=2) for f in [E_FLAT_5, C6]],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_1, A_FLAT_2]], [Note(f) for f in [E_FLAT_5, C6]],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4,    A_FLAT_5]], [],
        [Note(f, duration_in_beats=2) for f in [E_FLAT_1, E_FLAT_2,        E_FLAT_5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4,    A_FLAT_5]], [],

        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_1, B_FLAT_FROM_F_2]], [],
        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_3, D_FROM_F_4, F4,    D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=2) for f in [F1, F2,                             D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_3, D_FROM_F_4, F4]] + [Note(F5)], [Note(f, duration_in_beats=2) for f in [D_FROM_F_5, B_FLAT_FROM_F_5]],
        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_1, B_FLAT_FROM_F_2]], [Note(f) for f in [D_FROM_F_5, B_FLAT_FROM_F_5]],
        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_3, D_FROM_F_4, F4,    F5]], [],
        [Note(f, duration_in_beats=2) for f in [F1, F2,                             D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=2) for f in [B_FLAT_FROM_F_3, D_FROM_F_4, F4,    F5]], [],

        [Note(f, duration_in_beats=2) for f in [G1, G2, D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=2) for f in [G3, B3, D_FROM_G_4]] + [Note(f, duration_in_beats=4) for f in [D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=4) for f in [D_FROM_G_1, D_FROM_G_2]], [],
        [Note(f, duration_in_beats=2) for f in [G3, B3, D_FROM_G_4]] + [Note(f, duration_in_beats=4) for f in [D_FROM_G_5, B5]], [],
        [Note(f, duration_in_beats=2) for f in [G1, G2]], [],
        [Note(f, duration_in_beats=2) for f in [G1, G2,    D_FROM_G_5, B5]], [],
        [Note(f, duration_in_beats=2) for f in [A1, A2,]] + [Note(f, duration_in_beats=4) for f in [D_FROM_G_5, B5]], [],
        [Note(f, duration_in_beats=2) for f in [B1, B2]], [],

        [Note(f, duration_in_beats=2) for f in [C2, C3]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     E5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [G1, G2,         E5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4]] + [Note(G5)], [Note(f, duration_in_beats=2) for f in [E5, C6]],
        [Note(f, duration_in_beats=2) for f in [C2, C3]], [Note(f) for f in [E5, C6]],
        [Note(f, duration_in_beats=2) for f in [G3, C4, E4,     G5]], [],
        ...
        [Note(f, duration_in_beats=2) for f in [A_FLAT_1, A_FLAT_2]], [],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4,    E_FLAT_5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [E_FLAT_1, E_FLAT_2,        E_FLAT_5, C6]], [],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4]] + [Note(A_FLAT_5)], [Note(f, duration_in_beats=2) for f in [E_FLAT_5, C6]],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_1, A_FLAT_2]], [Note(f) for f in [E_FLAT_5, C6]],
        [Note(f, duration_in_beats=2) for f in [A_FLAT_3, C4, E_FLAT_4,    A_FLAT_5]], [],
