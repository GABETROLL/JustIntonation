...
melody = Melody(
    ...
    [
        ...
        [Note(f, duration_in_beats=2) for f in [D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [Note(f, duration_in_beats=4) for f in [D_FROM_F_5, B_FLAT_FROM_F_5]], [],
        [], [],
        [Note(f, duration_in_beats=4) for f in [D_FROM_G_5, B5]], [],
        [], [],
